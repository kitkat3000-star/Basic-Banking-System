...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
    ...
    else if($amount > $sql1['balance']) 
    {
        ...
        echo '<script type="text/javascript">';
        echo ' alert("Oops! You have Insufficient Balance")';  // showing an alert box.
        echo '</script>';
    }
    ...
    // constraint to check zero values
         ...
         echo "<script type='text/javascript'>";
         echo "alert('Oops! Null values cannot be transferred')";
         echo "</script>";
     }
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><p class="main-color"></p></a>
            </div>
        </div>
    </nav>

	<div class="container">
        <h1 class="text-center pt-4">Make Transaction</h1>
            <?php
                include 'connection.php';
                $sid=$_GET['id'];
